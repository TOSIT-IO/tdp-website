...
//   tosit: {
//     repositoryUrl: string
//     basic?: { tag: string; binaryUrl: string }
//     fix?: { tag: string; binaryUrl: string }
//   }
// }

export const stack31: {
  components: {
    name: string
    upstream: {
      label: string
  ...
  // Les dépendances ont une source mais pas de binaire (elles ne servent que pendant le build). TODO: à renommer en dépendances de build.
} = {
  components: [
    {
  ...
  dependencies: [
    {
      ...
      tosit: {
        ...
        sources: [{ type: 'basic', tag: '1.2.1.spark2-1.0' }],
      },
    },
    {
      ...
      tosit: {
        repositoryUrl: 'https://github.com/apache/hive',
        sources: [
          { type: 'basic', tag: '2.3.9-1.0' },
          { type: 'fix', tag: '2.3.9-1.1' },
        ],
      },
    },
  ],
