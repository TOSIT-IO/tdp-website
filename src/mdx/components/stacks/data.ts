          ...
          tosit: {
            ...
            releases: {
              ...
              fix: {
                tag: '2.6.0-1.1',
                binaryUrl: [
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-admin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-hbase-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-hdfs-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-hive-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-kms.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-knox-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-usersync.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.6.0-1.1/ranger-2.6.0-1.1-yarn-plugin.tar.gz',
                ],
              },
            },
          },
