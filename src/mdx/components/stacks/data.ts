      ...
      components: [
          ...
          tosit: {
            ...
            releases: {
              basic: {
                tag: '2.6.0-1.0',
                binaryUrl: [
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-admin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-hbase-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-hdfs-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-hive-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-kafka-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-kms.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-knox-plugin.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-usersync.tar.gz',
                  'https://github.com/TOSIT-IO/ranger/releases/download/2.0.0-1.0/ranger-2.6.0-1.0-yarn-plugin.tar.gz',
                ],
              },
            },
          },
        ...
        },
        {
          ...
          tosit: {
            ...
            releases: {
              basic: {
                tag: '1.3.0-SNAPSHOT-0.0',
                binaryUrl:
                  'https://github.com/TOSIT-IO/hbase-operator-tools/releases/download/1.3.0-SNAPSHOT-0.0/hbase-hbck2-1.3.0-SNAPSHOT-0.0.jar',
              },
            },
          },
        },
